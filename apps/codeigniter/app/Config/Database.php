...
class Database extends Config
{
    ...
    public function __construct()
    {
        ...
        $this->default['charset'] = (string) env('DB_CHARSET', $this->default['charset']);
        $this->default['DBCollat'] = (string) env('DB_COLLATION', $this->default['DBCollat']);
        $this->default['port'] = (int) env('DB_PORT', (string) $this->default['port']);
        $this->default['DBDebug'] = filter_var(env('DB_DEBUG', 'true'), FILTER_VALIDATE_BOOL);
